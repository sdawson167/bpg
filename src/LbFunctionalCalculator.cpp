...
double LbFunctionalCalculator::fQuad(fftw_complex* cplxFieldData, double* laplacian, int numFieldElements)
{
  double fQuad = 0.0;
...
double LbFunctionalCalculator::fNL(fftw_complex* realFieldData, int numFieldElements)
{
  double fNL = 0.0;
  for (int index = 0; index < numFieldElements; index++) {
...
double LbFunctionalCalculator::fNL(FieldProvider &field)
{
 ...
 *  ===========================================================
 */
double LbFunctionalCalculator::fQuadB(FieldProvider &field, double* b)
{
